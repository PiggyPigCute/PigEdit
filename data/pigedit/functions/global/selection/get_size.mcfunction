...
execute if score .dx pigedit.data matches ..-1 run scoreboard players operation .dx pigedit.data *= #-1 pigedit.data
...
execute if score .dy pigedit.data matches ..-1 run scoreboard players operation .dy pigedit.data *= #-1 pigedit.data
...
execute if score .dz pigedit.data matches ..-1 run scoreboard players operation .dz pigedit.data *= #-1 pigedit.data
