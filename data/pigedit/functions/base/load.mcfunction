...
data modify storage pigedit:data data.register.tool set value {id:"minecraft:warped_fungus_on_a_stick",tag:{pigedit:{tool:1b},CustomModelData:629000,Enchantement:[],display:{Name:'{"text":"PigEdit Tool","italic":false}'}}}
